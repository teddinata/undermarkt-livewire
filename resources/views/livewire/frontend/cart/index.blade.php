    ...
    $(document).ready(function () {
        ...
        $('select[name="kecamatan"]').on('change', function () {
            ...
            $('#courier').append('<div class="form-check form-check-inline">\n' +
                '  <input class="form-check-input select-courier" type="radio" name="courier" id="ongkos_kirim-sicepat" value="sicepat">\n' +
                '  <label class="form-check-label font-weight-bold mr-2" for="ongkos_kirim-sicepat">Sicepat Ekspres (SICEPAT)</label>\n' +
                ...
                '  <label class="form-check-label font-weight-bold mr-2" for="ongkos_kirim-jne">JNE Ekspres (JNE)</label>\n' +
                '</div>')
