@section('title')
Tambah Product &mdash; {{ $setting->admin_title }}
@endsection

<div class="row justify-content-center">
   <div class="col-md-12">
       <div class="card border-0 shadow rounded-1-lg">
               ...
               <form wire:submit.prevent="store">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Weight</label>
                            <input type="text" id="weight" class="form-control" wire:model.lazy="weight"
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               ...
                               <textarea id="content" rows="6"
                                    ...
                                    wire:model.lazy="content" placeholder="Content">{{ $content }}
                                </textarea>
                           </div>
                       </div>
                   </div>
                   <div class="row">
                       <div class="col-md-6">
                           <div class="form-group">
                               ...
                               <input type="text" wire:model.lazy="unit"
                                    ...
                                    placeholder="Unit Product, Example: gram, kg">
                                @error('unit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="unit_weight"
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               ...
                               <textarea class="form-control @error('description') is-invalid @enderror"
                                    ...
                                    rows="4" wire:model.lazy="description"
