...
<body style="background-color: #e2e8f0;">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" style="background-color: #171d26!important">
        <a class="navbar-brand font-weight-bold" href="{{ route('console.dashboard.index') }}">
            <img src="/images/undermarket logo 2.png" class="w-50" alt="" />
            {{-- <i class="fa fa-carrot"></i> Griya Store --}}
            </a>
