...
<div class="list-group">
    <a href="{{ route('customer.dashboard.index') }}" class="list-group-item list-group-item-action">
    ...
    <a href="{{ route('customer.profile.index') }}" class="list-group-item list-group-item-action">
